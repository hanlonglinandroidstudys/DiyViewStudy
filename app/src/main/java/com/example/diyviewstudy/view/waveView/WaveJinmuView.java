 ...
 * time: 2020/1/13
 */
public class WaveJinmuView extends View {
    int cr = 300;
    ...
    private void drawLeft(Canvas canvas) {
        ...
        leftPath.arcTo(new RectF(cx - cr, cy - cr, cx + cr, cy + cr), 90, 180, true);
    ...
    private void drawRight(Canvas canvas) {
        ...
        rightPath.arcTo(new RectF(cx - cr, cy - cr, cx + cr, cy + cr), -90, 180, true);
