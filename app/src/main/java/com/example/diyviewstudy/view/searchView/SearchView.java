...
public class SearchView extends View {
    ...
    private void drawDefault(Canvas canvas) {
        ...
        mPath.addArc(new RectF(cx - in_cr, cy - in_cr, cx + in_cr, cy + in_cr),
                0,
                360);
...
//        canvas.drawPath(dstPath, mPaint);
        ...
        mPath.moveTo(cx + in_cr, cy);
        mPath.addArc(new RectF(cx - in_cr, cy - in_cr, cx + in_cr, cy + in_cr),
                360 * startingFraction,
                360 - 360 * startingFraction);
        mPath.lineTo(cx + in_cr * 2, cy);
        canvas.rotate(45, cx, cy);
        canvas.drawPath(mPath, mPaint);
        canvas.restore();
    ...
    private void drawLoading(Canvas canvas) {
        ...
        canvas.drawText(loadingText,cx-textWidth/2,cy+((fontMetrics.bottom-fontMetrics.top)/2-fontMetrics.bottom),mTextPaint);
    }
