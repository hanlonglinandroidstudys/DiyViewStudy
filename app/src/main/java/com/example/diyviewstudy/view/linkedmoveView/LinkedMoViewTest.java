package com.example.diyviewstudy.view.linkedmoveView;
...
import com.example.diyviewstudy.view.linkedmoveView.adapter.SampleAdapter;
import com.example.diyviewstudy.view.linkedmoveView.view.ScrollItemContentLayout;
import com.example.diyviewstudy.view.linkedmoveView.view.ScrollItemLayout;
    ...
    private void dealHoverViewInScroll(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
        ...
        if (scrollY > oldScrollY) {
            ...
            for (int i = 0; i < ll_content.getList().size() - 1; i++) {
                ...
                Log.e(TAG, "dealHoverViewInScroll: height1->" + overlayHeight1 + ",height2->" + overlayHeight2);
